...
CREATE PROPERTY GRAPH agentiq_graph
  VERTEX TABLES (
    ...
    agentiq.part KEY (event_id, part_index) LABEL part PROPERTIES (id, event_id, part_index, text, thought, thought_signature, function_call_id, function_call_name, function_call_args, function_response_id, function_response_name, function_response_response, inline_data_mime_type, inline_data_bytes, inline_data_display_name, file_data_mime_type, file_data_uri, file_data_display_name, executable_code_language, executable_code_code, code_execution_outcome, code_execution_output, video_metadata_start_offset, video_metadata_end_offset, video_metadata_fps, audio_transcription, media_resolution, tool_call, tool_response, part_metadata),
    ...
    agentiq.state_delta KEY (event_id, "key") LABEL state_delta PROPERTIES (id, actions_id, event_id, scope, "key", value_json),
