...
CREATE PROPERTY GRAPH agentiq_graph
  VERTEX TABLES (
    ...
    agentiq.agent KEY (digest) LABEL agent PROPERTIES (id, digest, name, description, model, instruction, skills, tools, sub_agents, created_at_ts),
    ...
    agentiq.workflow_agent KEY (workflow_uuid) LABEL workflow_agent PROPERTIES (id, workflow_uuid, agent_digest, pinned_at_ts)
  )
  EDGE TABLES (
