...
// CreateSessionInput is the input of CreateSession.
...
const createSessionSQL = "SELECT agentiq.create_session(p_adk_id => $1, p_app_name => $2, p_user_id => $3, p_agent_digest => $4, p_workflow_uuid => $5, p_state => $6)"

// CreateSession calls agentiq.create_session through the handle the caller supplies.
//
// A failure the function itself raised arrives as an *exec.FunctionError
// carrying its SQLSTATE, reachable with errors.As.
func (c *Client) CreateSession(ctx context.Context, h exec.Handle, in CreateSessionInput) (string, error) {
	v, err := exec.Call(ctx, h, &compiler.CompiledCall{
		SQL:      createSessionSQL,
		Args:     []any{in.AdkId, in.AppName, in.UserId, in.AgentDigest, in.WorkflowUuid, in.State},
		Returns:  sdl.ReturnScalar,
		Schema:   "agentiq",
	...
	return gopgqlValue("CreateSession", v, gopgqlAsString)
}

// DeleteSessionInput is the input of DeleteSession.
...
const deleteSessionSQL = "SELECT agentiq.delete_session(p_adk_id => $1, p_app_name => $2, p_user_id => $3)"

// DeleteSession calls agentiq.delete_session through the handle the caller supplies.
//
// A failure the function itself raised arrives as an *exec.FunctionError
// carrying its SQLSTATE, reachable with errors.As.
func (c *Client) DeleteSession(ctx context.Context, h exec.Handle, in DeleteSessionInput) (int64, error) {
	v, err := exec.Call(ctx, h, &compiler.CompiledCall{
		SQL:      deleteSessionSQL,
		Args:     []any{in.AdkId, in.AppName, in.UserId},
		Returns:  sdl.ReturnScalar,
		Schema:   "agentiq",
	...
	return gopgqlValue("DeleteSession", v, gopgqlAsInt64)
}
...
var sessionsColumns = []string{"v0_k", "v0_c0", "v0_c1", "v0_c2", "v0_c3", "v0_c4", "v0_c5", "v0_c6", "v0_c7"}
...
var workflowWithStepsColumns = []string{"v0_k", "v0_c0", "v0_c1", "v0_c2", "v0_c3", "v0_c4", "v1_k0", "v1_k1", "v1_c0", "v1_c1", "v1_c2", "v1_c3"}
...
func (c *Client) WorkflowWithSteps(ctx context.Context, h exec.Handle, in WorkflowWithStepsInput) ([]WorkflowWithStepsWorkflow, error) {
	res, err := exec.Query(ctx, h, &compiler.Compiled{
		...
		Args:       []any{in.WorkflowUuid},
		Columns:    workflowWithStepsColumns,
